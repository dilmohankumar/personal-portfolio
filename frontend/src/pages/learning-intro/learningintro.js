...
const LearningIntro = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.mentorship) newErrors.mentorship = "Please select a mentorship type.";
    if (!formData.result) newErrors.result = "Please select an expected result.";
    return newErrors;
  };
            ...
            <div className="input-section">
              ...
              <div className="input-col">
                <div className="flexs">
                  ...
                  <select
                    className={`input-field ${errors.mentorship ? "error-border" : ""}`}
                    id="input-mentorship"
                    name="mentorship"
                  ...
                  {errors.mentorship && <span className="error-message">{errors.mentorship}</span>}
                </div>
                <div className="flexs">
                  <label className="input-label" htmlFor="input-result">Expected result</label>
                  <select
                    className={`input-field ${errors.result ? "error-border" : ""}`}
                    id="input-result"
                    name="result"
                  ...
                  {errors.result && <span className="error-message">{errors.result}</span>}
                </div>
              </div>
              <div className="flexs">
                <label className="input-label" htmlFor="input-journey">Your journey</label>
                <textarea
                  className={`textarea-field ${errors.journey ? "error-border" : ""}`}
                  id="input-journey"
                  name="journey"
                  ...
                  autoComplete="off"
                ></textarea>
                {errors.journey && <span className="error-message">{errors.journey}</span>}
              </div>
            </div>
